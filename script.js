...
const translations = {
  zh: {
    ...
    homeAboutText: "我目前在 NYU Courant 担任 Courant Instructor（博士后职位），与 Valentino Tosatti 合作。此前，我于 2024 年秋季在 SL Math 担任博士后；博士毕业于 UC Berkeley，导师是 Song Sun。",
    homeLinksAria: "相关链接",
    ...
    seminarsText: "我正在共同组织一个 informal online complex geometry seminar。",
  ...
  en: {
    ...
    seminarsEyebrow: "Seminars and notes",
    seminarsSectionTitle: "Seminars and notes",
    seminarsText: "I am co-organizing an informal online complex geometry seminar.",
