...
const translations = {
  zh: {
    ...
    heroTitleSuffix: "（张俊升）",
    heroText: "我的研究兴趣集中在 Kähler 几何及其与度量几何、代数几何的联系，特别是满足曲率条件的 Kähler 度量和 Kähler-Ricci flows。",
  ...
  en: {
    ...
    heroTitleSuffix: "",
    heroText: "My research interests center on Kähler geometry and its interactions with metric geometry and algebraic geometry. In particular, I study Kähler metrics satisfying curvature conditions and Kähler-Ricci flows.",
